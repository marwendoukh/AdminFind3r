#!/usr/bin/python
# Script maded by Na3iL to found the correct link of admin panel 
# for more information u can contact me on naeilzoueidi@gmail.com
# and for more tutos and toolz of pentestin6 u can visit my website :) 
# at http://na3il.com
...
try:
    ...
    print "\t#              #     ##  #     #       #     #    #            #"
    print "\t#              #      #  #     #  ######  ######  ######       #"
    print "\t#                                By AdminNa3iLFinder           #"
    print "\t#                                                              #"
    print "\t#                                               coded by Na3iL #"
    print "\t#              Greets to Mootaz Saad , XmaxTn , Patron Sellami #"
    print "\t################################################################"
    var1=0
    var2=0

    l0gs = ['admin/','administrator/','admin1/','admin2/','admin3/','admin4/','admin5/','usuarios/','usuario/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
